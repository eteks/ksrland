    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html"> KSR Developer</a>
        </div>
		...
		<div class="row">
	 		...
	 		<div class="col-lg-4">
		 		...
		 		<div class="hline"></div>
		 			<p>       
		 				No:29, 2nd floor,<br/>
		 				Subramanian Kovil street,<br/>
		 				kathirkamam, Puducherry - 9.<br/>
		 			</p>
		 			<p>
		 				Email: ksr@ksrdeveloper.com<br/>
		 				Tel: +91 00000-00000.
		 			</p>
	 		</div>
	 	</div><!--row -->
  	 ...
  	 <script src="https://maps.googleapis.com/maps/api/js"></script>
        <script type="application/javascript">
			...
			var contentString = '<div id="content">'+
		     	...
		     	'</div>'+
		     	'<div id="bodyContent">'+
		      	'<p><b>eTechnoservices</b></p>'+
		      	'<p>No:29, 2nd floor, Subramanian Kovil street,kathirkamam, Puducherry - 9</p>'+
		      	'<p>info@etekchnoServices.com</p>'+
		      	'<p>+919786243201</p>'+
		      	'</div>'+
		      	'</div>';
